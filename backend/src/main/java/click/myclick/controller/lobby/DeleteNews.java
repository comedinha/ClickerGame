...
public class DeleteNews {
    ...
    @Autowired
    public DeleteNews(final NewsService service, final NewsUtility newsUtility) {
    ...
    public ResponseEntity<?> addNews(@RequestBody final AddNewsDTO dto) {
        ...
        final int code = newsUtility.deleteNews(service, dto);
